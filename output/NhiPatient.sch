...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.nz/fhir/StructureDefinition/nzethnicity']) &gt;= 1">extension with URL = 'http://hl7.org.nz/fhir/StructureDefinition/nzethnicity': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.nz/fhir/StructureDefinition/informationsource']) &gt;= 1">extension with URL = 'http://hl7.org.nz/fhir/StructureDefinition/informationsource': minimum cardinality of 'extension' is 1</sch:assert>
